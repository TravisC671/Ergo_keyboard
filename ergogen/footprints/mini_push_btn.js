...
(footprint "SMD_025816_WRE" (version 20211014) (generator pcbnew)
  ...
  (fp_text value SMD_025816_WRE (at 0 0 unlocked) (layer F.Fab)
    (effects (font (size 1 1) (thickness 0.15)))
  )
  (fp_text user "*" (at -2.5146 -2.7256) (layer F.SilkS)
    (effects (font (size 1 1) (thickness 0.15)))
  )
  (fp_text user "*" (at -1.7526 -1.8112) (layer F.Fab)
    (effects (font (size 1 1) (thickness 0.15)))
  )
  ...
  (fp_line (start 2.6035 -0.7698) (end 2.6035 -1.4302) (layer "F.Fab") (width 0.0254))
  (fp_line (start 2.6035 -1.4302) (end 2.0955 -1.4302) (layer "F.Fab") (width 0.0254))
  (fp_text user "*" (at -1.7526 -1.8112 unlocked) (layer "F.Fab")
    (effects (font (size 1 1) (thickness 0.15)))
  )
  (fp_text user "*" (at -2.5146 -2.7256 unlocked) (layer "F.SilkS")
    (effects (font (size 1 1) (thickness 0.15)))
  )
